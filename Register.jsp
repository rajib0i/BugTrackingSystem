...
<form  name="editform" action="./Reg">
	<table width="100%">
	<tr>
	<td align=""><img src="./Images/header.jpg" height="120"></img></td>
	<td align=""><font face="arial narrow" size="5px" color="red"><b>Bug Tracking System</b></font></td>
	</tr>
	<tr>
...
<tr>
           ...
           <td><div align="left">
             <select name="HintQuestion" class="borderBlue">
               ...
               <OPTION value="What is the name of your first school?">What is the name of your school?
               <OPTION value="What is your favourite pass-time?">What is your favourite hobby?
               <OPTION value="What is your mother maiden name?">What is your mother's maiden name?
               <OPTION value="What is your favourite food?">What is your favourite color?
             </select>
           </div></td>
         </tr>
