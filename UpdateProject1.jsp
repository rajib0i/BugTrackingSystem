...
int DisRow=0;
	...
	%>
		...
		<tr><td align="center">Project Name:</td><td><input type="text" value=<%=pname%> name="pname"></td></tr>
		...
		<tr><td align="center">phone No:</td><td><input type="text"value=<%=phone%> name="phoneno" ></td></tr>
		<tr><td align="center">Email:</td><td><input type="text"value=<%=email%> name="emailid" ></td></tr>
